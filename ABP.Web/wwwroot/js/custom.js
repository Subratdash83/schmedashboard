...
function loadNavigation(pgName, gLink, pLink, fLink, lLink, title) {
  ...
  if (lLink != '')
    ...
    var DashboardRedirection = $("#hdndashboardpath").val();
    $('#navigation').html('<li class="breadcrumb-item"><a href="' + DashboardRedirection +'" title="Home" ><i class="fa fa-home"></i></a></li>' + totLink);
  $('#title').append(title);
  printHeader = title;
}
//left menu active